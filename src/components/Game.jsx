...
function Game({ options, onGameEnd, onNewGame }) {
  ...
  <div className="flex gap-4">
    <button 
      className="bg-[#FDA214] text-white px-4 py-2 rounded-[20px] hover:bg-[#FFB84A] max-[700px]:ml-[40px]  " 
      onClick={onNewGame} 
    >
      New Game
    </button>
  ...
  {playersCount === 1 && (
    <div className="text-black p-[15px]  rounded-md bg-[#DFE7EC] font-semibold">
